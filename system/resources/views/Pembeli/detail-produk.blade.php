                                            ...
                                            <div class="col-sm-12">
										      ...
										      ">
														<li style="margin-top: 10px; margin-bottom: 10px; margin-left: 10px; margin-right: 10px;">
										          		<a href="" style="color: #000"><i class="fa fa-user"></i>{{$komentar->user->nama}}</a> | <a href=""><i class="fa fa-clock-o"></i>{{$komentar->created_at->diffforHumans()}}</a>
										          		</li>
										        ...
										        ">
										          ...
										          <p style="margin-top: 5px; margin-bottom: -10px;"><b>Balasan</b></p>
										          	<li style="margin-bottom: 10px; margin-left: 10px; margin-right: 10px;">
										            	<a href="" style="color: #000"><i class="fa fa-user"></i>{{$child->user->nama}}</a> | <a href=""><i class="fa fa-clock-o"></i>{{$child->created_at->diffforHumans()}}</a>
										        	</li>
